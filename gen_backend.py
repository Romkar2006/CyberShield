"""Generates server/utils/huggingface.js using chr() so <| never appears in this source."""
import os, textwrap

BASE = r'c:\Users\Victus\OneDrive\Desktop\PERSONAL_PROJECT_01\server'

# Build Zephyr special tokens from char codes - avoids <| in this source file
_p = chr(60)+chr(124)   # <|
_s = chr(124)+chr(62)   # |>
SYS = _p+'system'+_s
END = _p+'end'+_s
...
path = os.path.join(BASE, 'utils', 'huggingface.js')
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, 'w', encoding='utf-8') as f:
    f.write(JS)
print('WROTE: utils/huggingface.js')
